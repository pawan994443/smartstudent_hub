        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <p className="text-sm">
                Verified Achievements <span className="font-bold">{verifiedCount}/{totalAchievements}</span>
              </p>
                ...
                {achievements.map((a) => (
                  <li key={a.id} className="flex justify-between items-center border-b pb-2">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">{a.date?.toDate ? a.date.toDate().toDateString() : ''}</p>
                    </div>
                    <span className={`px-3 py-1 rounded-full text-xs ${a.status === "Verified" ? "bg-blue-100 text-blue-600" : "bg-green-100 text-green-600"}`}>
                      {a.status}
                    </span>
                  </li>
                ))}
